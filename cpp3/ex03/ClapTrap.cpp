...
{
	std::cout << "ClapTrap: Custom name constructor called" << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		HitPoints += amount;
		std::cout << name << " repaired " << amount << " points, and now has " << HitPoints << " of health!" << std::endl;
		EnergyPoints--;
	}
	else if (!EnergyPoints)
		std::cout << name << " has no energy points, it can't be repaired!" << std::endl;
	else
